...
class MethodBeanValueWriterTests {
	...
	@Test
	void writeWithRuntimeBeanReference() {
		...
		Method method = ReflectionUtils.findMethod(SampleFactory.class, "createString", String.class);
		assertGeneratedCode(beanDefinition, method, (code) -> assertThat(code)
				.endsWith("SampleFactory.createString(context.getBean(\"testBean\", java.lang.String.class))"));
	}
